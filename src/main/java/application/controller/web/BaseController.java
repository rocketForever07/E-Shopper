...
public class BaseController {
    ...
    public LayoutHeaderVM getLayoutHeaderVM() {
        ...
        ArrayList<HeaderMenuVM> listMenuBottom=new ArrayList<>();
        headerMenuVMArrayList.add(new HeaderMenuVM("Home", "/","fa fa-home"));
        headerMenuVMArrayList.add(new HeaderMenuVM("Order History", "/order/history","fa fa-crosshairs"));
        headerMenuVMArrayList.add(new HeaderMenuVM("Cart", "/cart","fa fa-shopping-cart"));

        vm.setHeaderMenuVMList(headerMenuVMArrayList);
        vm.setUrlLogoCompany(CompanyConstant.urlLogoCompany);
